        ...
        {students.length === 0 ? (
          <Card className="text-center text-black py-20">
            ...
            <p className="text-gray-200 max-w-md mx-auto">
              Your interns will appear here once assigned by the administrator.
              Stay tuned!
            </p>
          </Card>
        ) : (
                  ...
                  <div className="bg-gradient-to-r from-primary to-secondary p-8 pb-6 text-white relative overflow-hidden">
                    ...
                    <div className="relative flex items-start gap-6">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="text-2xl text-black font-bold leading-tight">
                          {student?.name || "Unknown Student"}
                        </h3>
                        <p className="text-black text-lg opacity-90">
                  ...
                  <div className="p-8 space-y-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge
                          status={student?.internship?.status || "pending"}
                        />
                      </div>
                      <ProgressBar
                        value={75}
                    ...
                    <div className="flex flex-wrap gap-2 items-center">
                      {(student?.lateSubs || 0) > 0 && (
                        <Badge
                          status="rejected"
                          className="!bg-red-100/80 !text-red-900 !border-red-200"
                        >
                          {student?.lateSubs || 0} late submission
                          {(student?.lateSubs || 0) > 1 ? "s" : ""}
                        </Badge>
                      )}
                      <div className="ml-auto">
                        <motion.button
                          ...
                          onClick={() =>
                            setActiveTab(
                              activeTab === student?._id ? null : student?._id,
                            )
                          }
                      ...
                      {activeTab === student?._id && (
                        ...
                        >
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              <p className="font-semibold text-primary text-sm uppercase tracking-wide mb-2">
                                Phone
                              </p>
                          ...
                          <div className="flex gap-3 pt-4">
                            <motion.button
                              ...
                              className="flex-1 bg-emerald-500/90 hover:bg-emerald-600 text-white py-3 px-6 rounded-xl font-semibold shadow-lg transition-all"
                            >
                              Review Reports
                            </motion.button>
                            <motion.button
                              whileHover={{ scale: 1.01 }}
                              className="flex-1 bg-orange-500/90 hover:bg-orange-600 text-white py-3 px-6 rounded-xl font-semibold shadow-lg transition-all"
                            >
                              Assign Task
                            </motion.button>
                          </div>
