        ...
        {internships.length === 0 ? (
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 mb-12 leading-relaxed max-w-lg mx-auto">
              Your internship details will appear here once approved. Check your
              applications or contact admin if you believe this is an error.
            </p>
          </motion.div>
        ) : (
                    ...
                    <div>
                      <Card className="mb-8 p-8">
                        <h4 className="text-2xl font-black mb-6 bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent flex items-center gap-3">
                          📄 Required Documents
                          <Badge status="info" className="!px-4 !py-1 !text-sm">
                            Preview
                          </Badge>
                        </h4>
                        {internship.documents ? (
                          Object.entries(internship.documents).map(
                            ([docType, doc]) => (
                              <div
                                key={docType}
                                className="flex items-center gap-4 p-4 bg-gradient-to-r from-blue-50/50 to-indigo-50/50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl border border-blue-200/50 mb-3 text-black"
                              >
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <div className="text-sm text-gray-600 dark:text-gray-400 truncate max-w-xs">
                                    {doc.url
                                      ? `Uploaded: ${doc.url.split("/").pop()}`
                                      : "Not uploaded yet"}
                                  </div>
                                  {doc.verified !== undefined && (
                                    <Badge
                                      status={
                                        doc.verified ? "success" : "warning"
                                      }
                                      className="!ml-0 !mt-1"
                                    >
                                      {doc.verified
                                ...
                                {doc.url && (
                                  <a
                                    ...
                                    className="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold transition-all whitespace-nowrap"
                                  >
                                    View
                                  </a>
                                )}
