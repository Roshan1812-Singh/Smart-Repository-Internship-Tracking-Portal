          ...
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="text-xl opacity-90">
                Complete control over admin accounts and granular permission
                management
              </p>
            </div>
          </div>
        ...
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/30 dark:border-gray-700/50 overflow-hidden">
          <div className="p-8 border-b border-white/30 dark:border-gray-700/50">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              Manage permissions and security for all admin users
            </p>
          </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gradient-to-r from-gray-50/50 to-gray-100/50 dark:from-gray-800/50 dark:to-gray-700/50 backdrop-blur-sm">
                  <th className="px-8 py-6 text-left text-lg font-bold text-gray-900 dark:text-white border-b-2 border-gray-200/50 dark:border-gray-600/50">
                    Admin
                  </th>
                  <th className="px-8 py-6 text-left text-lg font-bold text-gray-900 dark:text-white border-b-2 border-gray-200/50 dark:border-gray-600/50">
                    Role
              ...
              <tbody className="divide-y divide-gray-200/50 dark:divide-gray-700/50">
                {admins.map((admin, index) => {
                  ...
                  return (
                    <tr
                      key={admin._id}
                      className={`hover:bg-gray-50/50 dark:hover:bg-gray-700/50 transition-all duration-200 ${index % 2 === 0 ? "bg-white/50 dark:bg-gray-800/30" : ""}`}
                    >
                      <td className="px-8 py-8">
                        <div className="flex items-center">
                          <div
                            className={`w-14 h-14 rounded-2xl flex items-center justify-center mr-4 shadow-lg text-white font-bold text-lg flex-shrink-0 ${
                      ...
                      <td className="px-8 py-8">
                        <span
                          className={`inline-flex items-center px-4 py-2 rounded-2xl font-bold text-sm uppercase tracking-wide shadow-md ${
                            admin.role === "superadmin"
                      ...
                      <td className="px-8 py-8">
                        <div className="space-y-2">
                          <div className="flex items-center">
                            <label className="w-44 text-sm font-semibold text-gray-700 dark:text-gray-300 flex-shrink-0">
                              Manage Admins:
                            </label>
