...
const MentorNoticeboard = () => {
  ...
  const fetchNotifications = async () => {
    setLoading(true);
    try {
      const res = await API.get("/admin/notifications?role=mentor");
  ...
  if (loading) {
    return (
      <div className="p-6 min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-900/20 to-teal-900/20">
                ...
                <div className="flex items-center gap-4 text-sm text-gray-400">
                  ...
                  {isRead ? (
                    ...
                    <button
                      ...
                      className="px-4 py-1 bg-emerald-500 hover:bg-emerald-600 text-white text-xs font-medium rounded-full transition-all"
                    >
                      Mark Read
                    </button>
                  )}
