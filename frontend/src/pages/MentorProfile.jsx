...
const MentorProfile = () => {
  ...
  const fetchProfile = async () => {
    try {
      ...
      setEditingSchedule(
        profileData.availabilitySchedule || generateDefaultSchedule(),
      );
  ...
  const handleUpdateSchedule = async () => {
    try {
      await MentorService.updateSchedule({
        availabilitySchedule: editingSchedule,
      });
      setProfile((prev) => ({
        ...prev,
        availabilitySchedule: editingSchedule,
    ...
    : [
        {
          ...
          items: [
            ...
            {
              label: "Years of Experience",
              value: `${editingData.experience || profile?.experience || 0}+ years`,
              icon: "📈",
            },
          ],
        },
        {
          ...
          items: [
            { label: "Email", value: profileData.email, icon: "📧" },
            {
              label: "LinkedIn",
              value:
                editingData.linkedin || profile?.linkedin ? (
                  <a
                    href={editingData.linkedin || profile.linkedin}
                    target="_blank"
            ...
            {
              label: "Phone",
              value: editingData.phone || profile?.phone || "N/A",
              icon: "📱",
            },
          ],
        },
              ...
              <Card className="p-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {section.items.map((item, itemIdx) => (
                    <div
                      key={item.label}
                      className="flex items-start gap-4 p-6 rounded-2xl bg-gradient-to-r from-blue-50/50 to-indigo-50/50 dark:from-blue-900/20 hover:from-blue-100 hover:to-indigo-100 group"
                    >
                      <div
                        className={`w-12 h-12 bg-gradient-to-br from-primary to-secondary rounded-2xl flex items-center justify-center shadow-lg flex-shrink-0 group-hover:scale-110 transition-transform ${item.icon}`}
                      >
                ...
                {skills.map((skill, idx) => (
                  ...
                  >
                    ...
                    <div className="relative z-10 text-center">
                      ...
                      <h4 className="font-bold text-xl mb-2 text-gray-900 group-hover:text-emerald-700">
                        {skill}
                      </h4>
            ...
            <DataTable
              columns={[
                ...
                { key: "internship.role", label: "Position", sortable: true },
                {
                  ...
                  label: "Status",
                  render: (_, row) => <Badge status={row.internship?.status} />,
                },
                {
                  key: "lateSubs",
                  label: "Late Subs",
        ...
        >
          <Card className="p-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-7 gap-4 text-center">
              {(editingSchedule || generateDefaultSchedule()).map(
                ({ day, slots }) => (
                  <div
                    key={day}
                    className="p-4 rounded-2xl bg-gradient-to-b from-emerald-100 to-emerald-200 dark:from-emerald-900/50 border-2 border-emerald-300/50 shadow-md"
                  >
          ...
          <Card className="p-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                {
                  title: "10+ Interns Successfully Mentored",
                  date: "Ongoing",
                  icon: "🎓",
                },
              ].map((achievement, idx) => (
              ...
              {resources.slice(0, 6).map((resource, idx) => (
                ...
                >
                  ...
                  <div className="relative z-10 flex items-start gap-4">
                    <div
                      className={`w-16 h-16 bg-gradient-to-br from-${resource.type === "Docs" ? "blue" : resource.type === "Video" ? "purple" : resource.type === "Repo" ? "emerald" : "orange"}-500 to-${resource.type === "Docs" ? "cyan" : resource.type === "Video" ? "violet" : resource.type === "Repo" ? "teal" : "rose"}-600 rounded-2xl flex items-center justify-center shadow-xl flex-shrink-0 group-hover:scale-110 text-black`}
                    >
                      <span
                    ...
                    <div className="flex-1">
                      ...
                      <Badge
                        status={resource.type.toLowerCase()}
