  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 mb-12 shadow-2xl">
        ...
        <form
          onSubmit={handleSend}
          className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-6xl"
        >
          <div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">
              Notice will be automatically removed after this date
            </p>
          </div>
        ...
        {notifications.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {notifications.map((notice) => (
              <div
                key={notice._id}
                className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 hover:border-blue-400 transition-all group"
              >
                ...
                <h3 className="font-bold text-lg mb-2 line-clamp-1 group-hover:line-clamp-2 transition-all">
                  {notice.title}
                </h3>
