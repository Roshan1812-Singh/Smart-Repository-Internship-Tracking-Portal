...
const PublicStudentRegister = () => {
  ...
  // Simple validation - no complex regex issues
  const validateForm = () => {
    const newErrors = {};
    ...
    if (!['1', '2', '3', '4'].includes(formData.year)) newErrors.year = "Select valid year";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Backend response:', response.status, data); // Debug log

      if (!response.ok) {
        toast.error(data.message || data.error || `Registration failed: ${response.status}`);
        return;
      }
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input 
                ...
                className={`w-full p-4 rounded-2xl border-2 transition-all focus:ring-4 focus:ring-indigo-500/20 ${
                  errors.name ? 'border-red-400 bg-red-50' : 'border-gray-200 hover:border-indigo-300'
                }`} 
            ...
            <div>
              ...
              <input 
                ...
                onChange={handleChange}
                className={`w-full p-4 rounded-2xl border-2 transition-all focus:ring-4 focus:ring-indigo-500/20 ${
                  errors.email ? 'border-red-400 bg-red-50' : 'border-gray-200 hover:border-indigo-300'
                }`} 
            ...
            <div>
              ...
              <input 
                ...
                onChange={handleChange}
                className={`w-full p-4 rounded-2xl border-2 transition-all focus:ring-4 focus:ring-indigo-500/20 ${
                  errors.phone ? 'border-red-400 bg-red-50' : 'border-gray-200 hover:border-indigo-300'
                }`} 
            ...
            <div>
              ...
              <select 
                ...
                onChange={handleChange}
                className={`w-full p-4 rounded-2xl border-2 transition-all focus:ring-4 focus:ring-indigo-500/20 ${
                  errors.year ? 'border-red-400 bg-red-50' : 'border-gray-200 hover:border-indigo-300'
                }`}
              >
            ...
            <div>
              ...
              <input 
                ...
                onChange={handleChange}
                className={`w-full p-4 rounded-2xl border-2 transition-all focus:ring-4 focus:ring-indigo-500/20 ${
                  errors.department ? 'border-red-400 bg-red-50' : 'border-gray-200 hover:border-indigo-300'
                }`} 
            ...
            {/* College */}
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">College <span className="text-red-500">*</span></label>
              <input 
                name="college" 
                value={formData.college} 
                onChange={handleChange}
                className={`w-full p-4 rounded-2xl border-2 transition-all focus:ring-4 focus:ring-indigo-500/20 ${
                  errors.college ? 'border-red-400 bg-red-50' : 'border-gray-200 hover:border-indigo-300'
                }`} 
            ...
            <div className="md:col-span-2">
              ...
              <input 
                ...
                onChange={handleChange}
                className={`w-full p-4 rounded-2xl border-2 transition-all focus:ring-4 focus:ring-indigo-500/20 ${
                  errors.course ? 'border-red-400 bg-red-50' : 'border-gray-200 hover:border-indigo-300'
                }`} 
            ...
            {/* Mentor Email */}
            <div className="md:col-span-2">
              <label className="block text-sm font-semibold text-gray-700 mb-2">Mentor Email (Optional)</label>
              <input 
                name="mentorEmail" 
                type="email"
