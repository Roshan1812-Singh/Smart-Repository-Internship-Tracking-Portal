      ...
      >
        <div className="p-6">
          ...
          <nav className="flex flex-col gap-4">
            ...
            {navItem("/student/applications", "My Applications")}
            {navItem("/student/profile", "Profile")}
            {navItem("/student/internship", "Internship Details")}
            {navItem("/student/reports", "Reports")}
            {navItem("/student/tasks", "Tasks")}
            {navItem("/student/documents", "Documents")}
            {navItem("/student/feedback", "Feedback")}
            {navItem("/student/final", "Final Submission")}
          </nav>
